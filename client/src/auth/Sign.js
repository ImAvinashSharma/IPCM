  ...
  return (
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
        ...
        <form className="mt-6">
          <div className="mb-2">
            <label for="email" className="block text-sm font-semibold text-gray-800"></label>
            Email
          ...
          <Link className="text-xs text-purple-600 hover:underline" to="/rest">
            Forget Password?
          </Link>
          <div className="mt-6">
        ...
        <p className="mt-8 text-xs font-light text-center text-gray-700">
          <Link className="font-medium text-purple-600 hover:underline" to="signup">
