...
function Forgot() {
  ...
  const forgotPassword = () => {
    setLoading(true);
    fetch("http://localhost:3001/api/auth/forgot", {
      method: "POST",
      headers: {
  ...
  return loading ? (
    ...
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
        <h1 className="text-3xl font-semibold text-center text-gray-700 uppercase">Forgot Password</h1>
        ...
        <div className="mt-6">
          <div className="mb-2">
            ...
            User Name
            <input required value={userName} onChange={e => setUserName(e.target.value)} type="text" className="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border rounded-md focus:border-gray-400 focus:ring-gray-300 focus:outline-none focus:ring focus:ring-opacity-40" />
          </div>
          <div className="mb-2">
          ...
          <Link className="text-xs text-gray-600 hover:underline" to="/forgotPassword">
            Forget Password?
          </Link>
          <div className="mt-6">
            <button onClick={forgotPassword} className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600">
              Login
            </button>
          </div>
        </div>
        ...
        <p className="mt-8 text-xs font-light text-center text-gray-700">
          <Link className="font-medium text-gray-600 hover:underline" to="/signin">
