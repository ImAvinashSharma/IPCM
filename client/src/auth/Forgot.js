    ...
    <div className="relative flex flex-col justify-center min-h-screen overflow-hidden">
      <div className="w-full p-6 m-auto bg-white rounded-md shadow-xl lg:max-w-xl">
        ...
        <div className="mt-6">
          ...
          <Link className="text-xs text-purple-600 hover:underline" to="/forgotPassword">
            Forget Password?
          </Link>
          <div className="mt-6">
            <button onClick={forgotPassword} className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-purple-700 rounded-md hover:bg-purple-600 focus:outline-none focus:bg-purple-600">
              Login
            </button>
          </div>
        </div>
        ...
        <p className="mt-8 text-xs font-light text-center text-gray-700">
          <Link className="font-medium text-purple-600 hover:underline" to="/signin">
